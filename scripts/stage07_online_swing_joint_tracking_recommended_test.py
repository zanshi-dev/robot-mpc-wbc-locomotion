...
LOG_CSV = "results/logs_sample/stage07_online_swing_joint_tracking_recommended_test_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_online_swing_joint_tracking_recommended_test_summary.csv"
...
def main():
    ...
    q_standing = current_actuated_q(data, qadrs)
    ...
    print("Stage 7 online swing joint tracking recommended test")
