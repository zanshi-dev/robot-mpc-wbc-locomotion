...
def main() -> int:
    ...
    roadmap = docs / "STAGE22_OBSERVABLE_PERTURBATION_ROBUSTNESS_ROADMAP.md"
    validation_csv = logs / "stage22_0_observable_perturbation_roadmap_validation.csv"
    summary_json = logs / "stage22_0_observable_perturbation_roadmap_summary.json"
    ...
    summary = {
        "stage": "22.0",
        "name": "observable perturbation robustness roadmap",
        "result": result,
        ...
        "perturbation_cases": [
            {"perturbation_id": "nominal", "perturb_vx": 0.00, "perturb_vy": 0.00, "perturb_yawrate": 0.00},
            {"perturbation_id": "vx_plus", "perturb_vx": 0.05, "perturb_vy": 0.00, "perturb_yawrate": 0.00},
            {"perturbation_id": "vx_minus", "perturb_vx": -0.05, "perturb_vy": 0.00, "perturb_yawrate": 0.00},
            {"perturbation_id": "vy_plus", "perturb_vx": 0.00, "perturb_vy": 0.03, "perturb_yawrate": 0.00},
            {"perturbation_id": "vy_minus", "perturb_vx": 0.00, "perturb_vy": -0.03, "perturb_yawrate": 0.00},
            {"perturbation_id": "yawrate_plus", "perturb_vx": 0.00, "perturb_vy": 0.00, "perturb_yawrate": 0.05},
            {"perturbation_id": "yawrate_minus", "perturb_vx": 0.00, "perturb_vy": 0.00, "perturb_yawrate": -0.05},
        ],
        "scale_anchors": [
            0.000,
            0.010,
    ...
    print(f"stage22_0_result: {result}")
