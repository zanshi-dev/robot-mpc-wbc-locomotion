...
def main() -> int:
    ...
    roadmap = docs / "STAGE19_VELOCITY_AWARE_SCALE_SWEEP_ROADMAP.md"
    validation_csv = logs / "stage19_0_velocity_aware_scale_sweep_roadmap_validation.csv"
    summary_json = logs / "stage19_0_velocity_aware_scale_sweep_roadmap_summary.json"
    ...
    summary = {
        "stage": "19.0",
        "name": "velocity-aware candidate scale sweep roadmap",
        "result": result,
    ...
    print(f"stage19_0_result: {result}")
