...
LOG_CSV = "results/logs_sample/stage07_online_full_wbc_with_scheduler_proto_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_online_full_wbc_with_scheduler_proto_summary.csv"
...
def main():
    ...
    print("Stage 7 online full WBC with scheduler proto")
