...
INPUT_CSV = "results/logs_sample/stage07_wbc_base_wrench_qp.csv"
LOG_CSV = "results/logs_sample/stage07_wbc_base_wrench_support_test_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_wbc_base_wrench_support_test_summary.csv"
...
def main():
    ...
    summary = {
        ...
        "pass": str(pass_test),
        "torque_source": "stage07_wbc_base_wrench_qp",
    }
    ...
    print("Stage 7 WBC base wrench support test")
