...
LOG_CSV_TEMPLATE = "results/logs_sample/stage23_2_qvel_trace_rollout_{perturbation_id}_{scale_tag}_{control_mode}_log.csv"
SUMMARY_CSV_TEMPLATE = "results/logs_sample/stage23_2_qvel_trace_rollout_{perturbation_id}_{scale_tag}_{control_mode}_summary.csv"
...
def main():
    ...
    summary = {
        ...
        "control_law_changed": args.control_mode == CONTROL_MODE_MPC_ASSISTED_CANDIDATE,
