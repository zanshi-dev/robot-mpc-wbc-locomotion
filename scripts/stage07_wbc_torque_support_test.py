...
INPUT_CSV = "results/logs_sample/stage07_minimal_wbc_torque_qp.csv"
LOG_CSV = "results/logs_sample/stage07_wbc_torque_support_test_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_wbc_torque_support_test_summary.csv"
...
def read_tau_wbc():
    ...
    for leg in LEG_ORDER:
        for joint in JOINTS:
            tau.append(float(row[f"wbc_{leg}_tau_{joint}"]))
...
def main():
    ...
    summary = {
        ...
        "pass": str(pass_test),
        "torque_source": "stage07_minimal_wbc_torque_qp",
    }
    ...
    print("Stage 7 WBC torque support test")
