...
OUTPUT_CSV = "results/logs_sample/stage07_online_stance_wbc_plus_swing_pd_sweep.csv"
...
STANCE_WBC_SCALE_LIST = [0.0, 0.25, 0.50, 0.75, 1.00]
SWING_PD_SCALE_LIST = [0.50, 0.75, 1.00]
TARGET_SCALE_LIST = [0.35, 0.45, 0.60]
...
def run_case(wbc, target_rows, stance_wbc_scale, swing_pd_scale, target_scale):
    ...
    for step in range(total_steps):
        ...
        q_err = q_des - q_now
        tau_pd_raw = KP_SWING * q_err - KD_SWING * qd_now
        tau_swing_pd = swing_pd_scale * swing_mask * tau_pd_raw

        tau_total_raw = tau_stance_wbc + tau_swing_pd
...
def main():
    ...
    print("Stage 7 online stance WBC plus swing PD sweep")
