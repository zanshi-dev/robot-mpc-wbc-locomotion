...
OUTPUT_CSV = "results/logs_sample/stage07_full_wbc_stance_constraint_qp.csv"
...
def solve_mode(model, data, site_ids, dofs, row, mode):
    ...
    # 当前 standing pose 且 qvel=0，因此 Jdot_v = 0
...
def main():
    ...
    print("Stage 7 full WBC stance constraint QP")
    ...
    for row in rows:
        print(
            ...
            f"num_stance_acc_constraints={row['num_stance_acc_constraints']} "
