...
INPUT_CSV = "results/logs_sample/stage07_swing_joint_target_sequence.csv"
LOG_CSV = "results/logs_sample/stage07_swing_joint_target_tracking_test_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_swing_joint_target_tracking_test_summary.csv"
...
def main():
    ...
    dofs, qadrs, actuator_names = actuator_indices(model)
    ...
    for target_row in target_rows:
        ...
        for local_step in range(KNOT_HOLD_STEPS):
            ...
            max_tau_abs = max(max_tau_abs, float(np.max(np.abs(tau))))
    ...
    print("Stage 7 swing joint target tracking test")
