...
LOG_CSV = "results/logs_sample/stage07_swing_joint_target_tracking_recommended_test_log.csv"
SUMMARY_CSV = "results/logs_sample/stage07_swing_joint_target_tracking_recommended_test_summary.csv"
...
def main():
    ...
    print("Stage 7 swing joint target tracking recommended test")
