...
LOG_CSV_TEMPLATE = "results/logs_sample/stage19_2_velocity_scale_{scale_tag}_{control_mode}_log.csv"
SUMMARY_CSV_TEMPLATE = "results/logs_sample/stage19_2_velocity_scale_{scale_tag}_{control_mode}_summary.csv"
...
def main():
    ...
    log_csv = LOG_CSV_TEMPLATE.format(scale_tag=args.scale_tag, control_mode=args.control_mode)
    summary_csv = SUMMARY_CSV_TEMPLATE.format(scale_tag=args.scale_tag, control_mode=args.control_mode)
