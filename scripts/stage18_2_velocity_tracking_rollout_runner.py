...
LOG_CSV_TEMPLATE = "results/logs_sample/stage18_2_velocity_tracking_{control_mode}_log.csv"
SUMMARY_CSV_TEMPLATE = "results/logs_sample/stage18_2_velocity_tracking_{control_mode}_summary.csv"
